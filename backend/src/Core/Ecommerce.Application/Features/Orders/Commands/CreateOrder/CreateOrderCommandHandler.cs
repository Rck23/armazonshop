...
public class CreateOrderCommandHandler : IRequestHandler<CreateOrderCommand, OrderVm>
{
    ...
    {
        // ELIMINAR ORDENES PENDIENTES DEL USUARIO ACTIVO
        ...
        // BUSCAR LOS ELEMENTOS DEL CARRITO DE COMPRA 
        ...
        // SACAR LA DIRECCION DESDE EL USUARIO
        ...
        // CREAR UNA DIRECCION PARA LA ORDEN DE COMPRA
        ...
        // OBTENER LOS DATOS CALCULADOS (PRECIO, TARIFAS, ETC..)
        ...
        if(resultado <= 0)
        {
            throw new Exception("Error creando la orden de compras");
        }
        ...
        if(resultadoOrder <= 0)
        {
            throw new Exception("Error creando el pago en Stripe.");
        }
